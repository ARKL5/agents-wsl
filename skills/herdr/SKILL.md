---
name: herdr
description: "Control Herdr to open and coordinate coding agents in panes. Use when the user mentions Herdr, or asks to open or start another harness (Grok, Codex, Pi, Agy, OpenCode), or to inspect or control panes, tabs, workspaces, or another agent. Do not use merely because a task could benefit from a background terminal, generic delegation, or parallel work. Requires HERDR_ENV=1."
---
